...
public class LayoutModel implements IPropertySource {
	...
	static {
		descriptors = new IPropertyDescriptor[] {
				new TextPropertyDescriptor(VERTICAL_SPACE),
				new TextPropertyDescriptor(HORIZANTAL_SPACE),
				new TextPropertyDescriptor(ALIGNMENT),
				new TextPropertyDescriptor(NODE_WIDTH),
				new TextPropertyDescriptor(NODE_HEIGHT),
			};
	}
